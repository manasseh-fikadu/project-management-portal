...
CREATE INDEX "procurement_requests_budget_allocation_id_idx" ON "procurement_requests" ("budget_allocation_id");
CREATE INDEX "procurement_requests_task_id_idx" ON "procurement_requests" ("task_id");
...
CREATE INDEX "procurement_requests_selected_vendor_id_idx" ON "procurement_requests" ("selected_vendor_id");

CREATE INDEX "procurement_request_items_request_id_idx" ON "procurement_request_items" ("procurement_request_id");

CREATE INDEX "vendor_quotations_request_id_idx" ON "vendor_quotations" ("procurement_request_id");
...
CREATE INDEX "goods_receipts_request_id_idx" ON "goods_receipts" ("procurement_request_id");
...
CREATE INDEX "supplier_invoices_request_id_idx" ON "supplier_invoices" ("procurement_request_id");
...
CREATE INDEX "procurement_documents_request_id_idx" ON "procurement_documents" ("procurement_request_id");
CREATE INDEX "procurement_documents_quotation_id_idx" ON "procurement_documents" ("quotation_id");
...
CREATE INDEX "procurement_documents_supplier_invoice_id_idx" ON "procurement_documents" ("supplier_invoice_id");

CREATE INDEX "procurement_approvals_request_id_idx" ON "procurement_approvals" ("procurement_request_id");
CREATE INDEX "procurement_approvals_approver_id_idx" ON "procurement_approvals" ("approver_id");
